...
public class FirstAttempt {
    ...
    public void testCardIsntValidTestCase() throws Exception {
        ...
        assertEquals(driver.findElement(By.xpath("//div[@id='card-expires-field']/label/span")).getText(), "Expires");
        assertEquals(driver.findElement(By.xpath("//div[@id='card-cvc-field']/label/span")).getText(), "CVV2/CVC2/CAV2");
